...
select
	case
		when datedif('years', birth_date, current_date) < 20 then '0-20'
		when datedif('years', birth_date, current_date) < 40 then '20-40'
		when datedif('years', birth_date, current_date) < 60 then '40-60'
		when datedif('years', birth_date, current_date) < 80 then '60-80'
