...
Objetos -> São instâncias de classe. Ou seja, após o mapeamento
do objeto no mundo real para sua representação computacional,
devemos poder criar quantos objetos forem necessários. Podemos
pensar nos objetos/instâncias de uma classe como váriáveis
