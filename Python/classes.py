...
com inicial em maiúsculo. Se o nome for composto, utliza-se as iniciais de ambas as palavras
em maiúsulo. Se o nome for composto, utiliza-se as iniciais de ambas as palavras em maiúculo,
todas juntas.
"""
